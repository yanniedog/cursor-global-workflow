...
- Babysit / pr-fix (by name): babysit skill etc must always address PR bot feedback where appropriate
- Shared contract: repo `WORKFLOW.md`, `rules/respond-to-each-review-comment.mdc`, `rules/pr-review-bot-replies.mdc`
